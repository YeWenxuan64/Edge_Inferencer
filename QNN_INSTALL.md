...
网页下载: [Qualcomm Software Center](https://softwarecenter.qualcomm.com/catalog/item/Qualcomm_AI_Runtime_Community?osArch=Any&osType=All&version=2.38.0.250901)<br>
...
> qairt/2.38.0.250901/docs/QNN/general/overview.html#supported-snapdragon-devices
...
# 配置环境变量（替换为实际路径）
source ./qairt/2.38.0.250901/bin/envsetup.sh
